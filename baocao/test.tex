...
Item List Page: Hiển thị danh sách các item đang được bán hoặc quyên góp.

\begin{figure}[H]
\centering
\includegraphics[width=0.75\textwidth]{Item List Page.png}
\caption{Item List Page}
\label{fig:item-list-page}
\end{figure}
...
My Purchases Page: Hiển thị danh sách các item mà member đã mua.
...
Purchase Detail / Review Page: Cho phép member xem chi tiết đơn mua hoặc đánh giá sau khi mua.
...
Campaign Detail Page: Hiển thị thông tin chi tiết của một item donation campaign.
...
Donation Page: Cho phép member nhập số tiền muốn quyên góp cho campaign.
...
Campaign Detail Page: Hiển thị thông tin, progress và danh sách donation trong campaign.
...
Donated Item List Page: Hiển thị các item được member gửi vào campaign.
...
Donated Item Detail Page: Cho phép xem thông tin chi tiết của item được gửi đến tổ chức.
...
Approval Page: Cho phép organization admin approve hoặc reject donated item.

\begin{figure}[H]
\centering
\includegraphics[width=0.75\textwidth]{Donation Item Approval Form.png}
\caption{Approval Page}
